...
#ifndef ASSEMBLY_LOCK_HPP_
#define ASSEMBLY_LOCK_HPP_
...
class AssemblyLock : public gazebo::ModelPlugin
{
public:
  /// Constructor
  AssemblyLock();
...
private:
  ...
  /// data members.
  std::unique_ptr<AssemblyLockPrivate> impl_;
};
}  // namespace gazebo_plugins

#endif  // ASSEMBLY_LOCK_HPP_
