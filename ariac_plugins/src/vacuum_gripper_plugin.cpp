  ...
  ariac_msgs::srv::ChangeGripper::Response::SharedPtr res)
{
  ...
  kts1_parts.x = -1.100; kts1_parts.y = -5.380; kts1_parts.z = 0.675;

  geometry_msgs::msg::Point kts2_parts;
  kts2_parts.x = -1.500; kts2_parts.y = 5.380; kts2_parts.z = 0.675;

  geometry_msgs::msg::Point kts1_trays;
  kts1_trays.x = -1.500; kts1_trays.y = -5.380; kts1_trays.z = 0.675;

  geometry_msgs::msg::Point kts2_trays;
  kts2_trays.x = -1.100; kts2_trays.y = 5.380; kts2_trays.z = 0.675;
