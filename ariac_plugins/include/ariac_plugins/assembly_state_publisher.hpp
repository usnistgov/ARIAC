...
#ifndef ASSEMBLY_CONTENT_HPP_
#define ASSEMBLY_CONTENT_HPP_
...
class AssemblyStatePublisher: public gazebo::ModelPlugin
{
public:
  /// Constructor
  AssemblyStatePublisher();

  /// Destructor
  virtual ~AssemblyStatePublisher();
  ...
  void UpdateBattery(ConstPosePtr&);
  void UpdatePump(ConstPosePtr&);
  void UpdateRegulator(ConstPosePtr&);
  void UpdateSensor(ConstPosePtr&);
...
private:
  ...
  /// data members.
  std::unique_ptr<AssemblyStatePublisherPrivate> impl_;
};
}  // namespace gazebo_plugins

#endif  // ASSEMBLY_CONTENT_HPP_
