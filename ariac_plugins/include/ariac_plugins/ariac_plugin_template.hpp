...
#ifndef ARIAC_PLUGINS_TEMPLATE_HPP_
#define ARIAC_PLUGINS_TEMPLATE_HPP_
...
class AriacPluginTemplate : public gazebo::ModelPlugin
{
public:
  /// Constructor
  AriacPluginTemplate();
...
private:
  ...
  /// data members.
  std::unique_ptr<AriacPluginTemplatePrivate> impl_;
};
}  // namespace gazebo_plugins

#endif  // ARIAC_PLUGINS_TEMPLATE_HPP_
