...
orders:
  order_0:
    ...
    kitting_robot = get_field_with_default(order_dict, 'kitting_robot', "on")
    assembly_robot = get_field_with_default(order_dict, 'assembly_robot', "on")
    # print("kitting_robot", kitting_robot)
    ...
    returned_dict = {}
    returned_dict['kitting_robot'] = kitting_robot
    returned_dict['assembly_robot'] = assembly_robot
