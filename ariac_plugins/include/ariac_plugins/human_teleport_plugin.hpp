#ifndef ARIAC_PLUGINS__HUMAN_TELEPORT_PLUGIN_HPP_
#define ARIAC_PLUGINS__HUMAN_TELEPORT_PLUGIN_HPP_
...
private:
  ...
  /// data members.
  std::unique_ptr<HumanTeleportPluginPrivate> impl_;
};
}  // namespace ariac_plugins

#endif  // ARIAC_PLUGINS__HUMAN_TELEPORT_PLUGIN_HPP_