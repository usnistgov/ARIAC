...
#ifndef OBJECT_DISPOSAL_PLUGIN_HPP_
#define OBJECT_DISPOSAL_PLUGIN_HPP_
...
class ObjectDisposalPlugin : public gazebo::ModelPlugin
{
public:
  /// Constructor
...
private:
  ...
  /// data members.
  std::unique_ptr<ObjectDisposalPluginPrivate> impl_;
};
}  // namespace ariac_plugins

#endif  // OBJECT_DISPOSAL_PLUGIN_HPP_
